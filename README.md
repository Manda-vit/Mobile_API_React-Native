<h1 align="center">
    <img alt="FicandoOnline" title="#FicandoOnline"  />
</h1>
...
O AluraHub é uma aplicação feita em React Native que permite pesquisar um perfil com informações como nome da pessoa e uma foto, e possibilita consultar um repositório que armazena dados.

No projeto foi utilizada a API pública do gitHub, o que só torna possível consultar dados. Feito com fakeAPI é possível fazer as operações de CRUD.
